...
namespace HospitalManagementSystem.Server.Data.Migrations
{
    ...
    [Migration("20220216161319_AddedDifferenceToExpense")]
    partial class AddedDifferenceToExpense
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HospitalManagementSystem.Server.Models.Appointment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("HospitalManagementSystem.Server.Models.Bed", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("HospitalManagementSystem.Server.Models.Expense", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("HospitalManagementSystem.Server.Models.Floor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("HospitalManagementSystem.Server.Models.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("HospitalManagementSystem.Server.Models.UserMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("HospitalManagementSystem.Server.Models.Appointment", b =>
                {
                    ...
                    b.HasOne("HospitalManagementSystem.Server.Models.ApplicationUser", "Doctor")
                        .WithMany("AppointmentsSupervised")
            ...
            modelBuilder.Entity("HospitalManagementSystem.Server.Models.Bed", b =>
                {
                    b.HasOne("HospitalManagementSystem.Server.Models.Room", "Room")
                        .WithMany("Beds")
            ...
            modelBuilder.Entity("HospitalManagementSystem.Server.Models.Message", b =>
                {
                    ...
                    b.HasOne("HospitalManagementSystem.Server.Models.Message", "Parent")
                        .WithMany()
            ...
            modelBuilder.Entity("HospitalManagementSystem.Server.Models.Room", b =>
                {
                    b.HasOne("HospitalManagementSystem.Server.Models.Floor", "Floor")
                        .WithMany("Rooms")
            ...
            modelBuilder.Entity("HospitalManagementSystem.Server.Models.UserMessage", b =>
                {
                    b.HasOne("HospitalManagementSystem.Server.Models.Message", "Message")
                        .WithMany("Users")
                        .HasForeignKey("MessageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HospitalManagementSystem.Server.Models.ApplicationUser", "User")

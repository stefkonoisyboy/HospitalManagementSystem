        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Documentations_AspNetUsers_PatientId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Payments_AspNetUsers_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DocumentDocumentations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DocumentDocumentations_Documentations_DocumentationId",
                        column: x => x.DocumentationId,
                        principalTable: "Documentations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DocumentDocumentations_Documents_DocumentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Documentations_PatientId",
                table: "Documentations",
                column: "PatientId");

            migrationBuilder.CreateIndex(
                name: "IX_DocumentDocumentations_DocumentationId",
                table: "DocumentDocumentations",
                column: "DocumentationId");

            migrationBuilder.CreateIndex(
                name: "IX_DocumentDocumentations_DocumentId",
                table: "DocumentDocumentations",
                column: "DocumentId");
